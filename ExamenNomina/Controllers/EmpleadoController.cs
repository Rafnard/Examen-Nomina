...
namespace ExamenNomina.Controllers
{
    public class EmpleadoController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdEmpleado,IdDepartamento,NomEmpleado,Activo")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdEmpleado,IdDepartamento,NomEmpleado,Activo")] Empleado empleado)
        {
            if (ModelState.IsValid)
            {
